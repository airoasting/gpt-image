...
- 제품/음식 커머셜 렌더(구조화 config 포함) → `gallery-product-and-brand.md`.
- 브랜드·포스터·타이포·밀집 한글/중문 → `gallery-typography-and-posters.md`.
- 연구·데이터·기술·과학 도해 → `gallery-infographics-and-field-guides.md`.
- UI/앱/대시보드 목업 → `gallery-ui-ux-mockups.md`.
